...
## Features:
* Device Admin Settings redirect on App first launch (opening the installed app for the first time)
* Battery optimization disabled (keep the app active in sleep mode for long periods of time)
* Exrtra Options in the settings
## Thanks:
...
## Donations
Donate original creator through [PayPal](http://paypal.me/AndyAdshead): http://paypal.me/AndyAdshead
